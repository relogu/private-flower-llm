...
if __name__ == "__main__":
    img_root = Path("/datasets/FedScale/leaf_shakespeare")
    cid_csv_root = Path("/datasets/FedScale/leaf_shakespeare/client_data_mapping")

    train_dataset = SHAKESPEARE(img_root)
    ...
    train_dataset = SHAKESPEARE_LOADED(img_root)
