...
DATETIME=$(date '+%Y%m%d_%H%M%S')
python /nfs-share/ls985/projects/flower_llm/flower_llm/dataset/train_tokenizer.py --output_root_dir "/nfs-share/ls985/projects/flower_llm/" --path allenai/c4 --name sr --splits train --vocab_size 250112 2>&1 | tee "$SAVE_PATH"/tokenizer_training_sr_train_250112_$DATETIME.log
