...
GRPC_VERBOSITY=debug CUDA_LAUNCH_BLOCKING=1 HYDRA_FULL_ERROR=1 poetry run python -m flower_llm.node_manager.node_manager --persist-client 2>&1 | tee "$POLLEN_SAVE_PATH"/node_manager.log &
