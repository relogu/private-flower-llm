...
# unset SAVE_PATH
# . "$PROJECT_PATH"/scripts/photon_llm_75M.sh

# unset RUN_UUID
# export RUN_UUID="fed-125M-reset-20240323_213000-fix-nesto"
# unset SAVE_PATH
# . "$PROJECT_PATH"/scripts/photon_llm_125M.sh

# unset RUN_UUID
# export RUN_UUID="fed-1B-20240322_221900-fix-nesto"
# unset SAVE_PATH
# . "$PROJECT_PATH"/scripts/photon_llm_1B.sh

unset RUN_UUID
unset SAVE_PATH
. "$PROJECT_PATH"/scripts/photon_llm_3B.sh

# unset RUN_UUID
# unset SAVE_PATH
# . "$PROJECT_PATH"/scripts/photon_llm_7B.sh
...
# unset SAVE_PATH
# . "$PROJECT_PATH"/scripts/photon_llm_small.sh
