...
export EXTERNAL_CONFIGS="$EXTERNAL_CONFIGS llm_config.local_steps=$LOCAL_STEPS"
...
export EXTERNAL_CONFIGS="$EXTERNAL_CONFIGS llm_config.save_interval=$LOCAL_STEPS"
export EXTERNAL_CONFIGS="$EXTERNAL_CONFIGS fl.n_total_clients=$CPR"
export EXTERNAL_CONFIGS="$EXTERNAL_CONFIGS fl.fake_gradient_update=true fl.fake_gradient_update_steps=6"
# Linear scaling
