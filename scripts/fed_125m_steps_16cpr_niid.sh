...
export EXTERNAL_CONFIGS="$EXTERNAL_CONFIGS dataset/streams@dataset.train.streams=the_pile_${CPR}_clients_mlsys"
export EXTERNAL_CONFIGS="$EXTERNAL_CONFIGS dataset/streams@dataset.val.streams=the_pile_${CPR}_clients_mlsys"
