...
POLLEN_CONFIG="$POLLEN_CONFIG dataset=fed-the_pile"                                      # Dataset name
...
POLLEN_CONFIG="$POLLEN_CONFIG dataset/streams@dataset.train.streams=the_pile_64_clients" # Stream configuration for the training dataset -- 64 clients
POLLEN_CONFIG="$POLLEN_CONFIG dataset/streams@dataset.val.streams=the_pile_64_clients"   # Stream configuration for the training dataset --  64 clients
...
POLLEN_CONFIG="$POLLEN_CONFIG pollen.n_nodes=2"                  # Number of nodes in the Photon federation
...
POLLEN_CONFIG="$POLLEN_CONFIG fl.n_clients_per_round=3" # Number of clients per round
POLLEN_CONFIG="$POLLEN_CONFIG fl.n_rounds=130"          # Total number of rounds
...
# POLLEN_CONFIG="$POLLEN_CONFIG llm_config.optimizer.lr=4.0e-4"       # DiLoCo
...
POLLEN_CONFIG="$POLLEN_CONFIG llm_config.global_train_batch_size=128"
...
POLLEN_CONFIG="$POLLEN_CONFIG llm_config.eval_subset_num_batches=10"       # Evaluate only 10 batches of the entire validation set
