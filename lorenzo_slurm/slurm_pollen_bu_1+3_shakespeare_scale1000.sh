...
#SBATCH --gres=gpu:3
#SBATCH --job-name=PS13-bu-scale1k
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=shakespeare_memory task.n_clients_per_round=1000 task.num_rounds=40 local_epochs=1 placement_policy=$policy flwr_address=$ip:6479"
