...
#SBATCH --gres=gpu:3
#SBATCH --job-name=PO13-bu-scale10k
#SBATCH --cpus-per-task 24
#SBATCH --ntasks-per-node=1
#SBATCH --output=%x-%j.out
#SBATCH --time=07:00:00
#SBATCH --dependency=afterany:82086
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=openimage task.n_clients_per_round=10000 task.num_rounds=5 local_epochs=1 placement_policy=$policy flwr_address=$ip:6480"
