...
for policy in "lb" "llb" "rr"; do
    ...
    CUSTOM_HYDRA_ARGS="num_nodes=1 run_uuid=$run_uuid task=shakespeare_memory task.n_clients_per_round=10 task.num_rounds=100 local_epochs=1 placement_policy=$policy flwr_address=127.0.0.1:6479"
