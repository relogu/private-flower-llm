...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=openimage task.n_clients_per_round=1000 task.num_rounds=100 local_epochs=1 placement_policy=rr flwr_address=$ip:6380"
