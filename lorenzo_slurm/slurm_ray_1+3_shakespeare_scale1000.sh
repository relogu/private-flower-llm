...
#SBATCH --dependency=afterany:78303
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=shakespeare_memory task.n_clients_per_round=1000 task.num_rounds=40 local_epochs=1 ray_address="auto" ray_redis_password=$redis_password ray_node_ip_address=$ip"
