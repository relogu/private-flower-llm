...
#SBATCH --dependency=afterany:78059
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=openimage task.n_clients_per_round=10000 task.num_rounds=5 local_epochs=1 ray_address="auto" ray_redis_password=$redis_password ray_node_ip_address=$ip"
