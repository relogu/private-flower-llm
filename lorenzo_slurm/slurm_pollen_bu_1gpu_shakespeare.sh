...
#SBATCH -w mauao
#SBATCH --gres=gpu:1
#SBATCH --job-name=PS1-bu
#SBATCH --tasks-per-node=1
#SBATCH --output=%x-%j.out
#SBATCH --dependency=afterany:78325
...
CUSTOM_HYDRA_ARGS="num_nodes=1 run_uuid=$run_uuid task=shakespeare_memory task.n_clients_per_round=100 task.num_rounds=100 local_epochs=1 placement_policy=$policy flwr_address=127.0.0.1:6479"
