...
#SBATCH --gres=gpu:3
#SBATCH --job-name=PG13-bu-scale2k
#SBATCH --cpus-per-task 24
#SBATCH --ntasks-per-node=1
#SBATCH --output=%x-%j.out
#SBATCH --time=07:00:00
#SBATCH --dependency=afterany:82089
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=google_speech task.n_clients_per_round=2000 task.num_rounds=10 local_epochs=1 placement_policy=$policy flwr_address=$ip:6481"
