...
#SBATCH --gres=gpu:3
#SBATCH --job-name=PS13-llb-scale1k
#SBATCH --cpus-per-task 24
#SBATCH --ntasks-per-node=1
#SBATCH --output=%x-%j.out
#SBATCH --time=04:00:00
#!SBATCH --dependency=afterany:78156
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=shakespeare_memory task.n_clients_per_round=1000 task.num_rounds=40 local_epochs=1 placement_policy=$policy flwr_address=$ip:6379"
