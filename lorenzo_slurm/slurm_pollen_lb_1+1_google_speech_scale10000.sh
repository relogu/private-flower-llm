...
#SBATCH --gres=gpu:1
#SBATCH --job-name=PG11-lb-scale10k
#SBATCH --cpus-per-task 8
#SBATCH --ntasks-per-node=1
#SBATCH --output=%x-%j.out
#SBATCH --time=07:00:00
#!SBATCH --dependency=afterany:78336
...
CUSTOM_HYDRA_ARGS="num_nodes=2 run_uuid=$run_uuid task=google_speech task.n_clients_per_round=10000 task.num_rounds=10 local_epochs=1 placement_policy=$policy flwr_address=$ip:6381"
