...
if [[ $GPU_TYPE == *'A40'* ]]; then
    ...
    LLM_CONFIG_MPT_16M="llm_config=mpt-16m llm_config.device_train_microbatch_size=64 llm_config.device_eval_batch_size=50"
    ...
    LLM_CONFIG_MPT_540M="llm_config=mpt-540m llm_config.device_train_microbatch_size=18 llm_config.device_eval_batch_size=40"
    ...
    LLM_CONFIG_MPT_540M="llm_config=mpt-540m llm_config.device_train_microbatch_size=15 llm_config.device_eval_batch_size=40"
