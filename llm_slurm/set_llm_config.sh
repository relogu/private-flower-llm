...
if [[ $GPU_TYPE == *'A40'* ]]; then
    ...
    LLM_CONFIG_MPT_11M="llm_config=mpt-11m llm_config.device_train_microbatch_size=64 llm_config.device_eval_batch_size=50"
    ...
    LLM_CONFIG_MPT_11M="llm_config=mpt-11m llm_config.device_train_microbatch_size=128 llm_config.device_eval_batch_size=50"
...
if [[ "$1" == "small" ]]; then
    ...
    export LLM_CONFIG=$LLM_CONFIG_MPT_11M
elif [[ "$1" == "125M" ]]; then
