...
POLLEN_CONFIG="pollen.server_address='localhost:50737' run_uuid=fed-75M-$DATETIME pollen.refresh_period=20 fl.n_rounds=176 llm_config.scheduler.t_max=88000ba llm_config.scheduler.t_warmup=1000ba"
