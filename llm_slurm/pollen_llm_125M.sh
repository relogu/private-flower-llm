...
. $PROJECT_PATH/llm_slurm/set_llm_config.sh "125M"
...
POLLEN_CONFIG="$POLLEN_CONFIG llm_config.scheduler.t_max=4800ba llm_config.scheduler.t_warmup=100ba llm_config.scheduler.alpha_f=0.1 llm_config.optimizer.lr=6.0e-4"
