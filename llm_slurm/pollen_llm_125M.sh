...
POLLEN_CONFIG="$POLLEN_CONFIG pollen.checkpoint=true llm_config.save_overwrite=true pollen.n_nodes=1 pollen.resume_round=5 pollen.fit_collaborative=false pollen.restore_run_uuid=fed-125M-20240328_000428-re-restart-1"
POLLEN_CONFIG="$POLLEN_CONFIG llm_config.scheduler.t_max=3000ba llm_config.scheduler.t_warmup=2500ba llm_config.scheduler.alpha_f=0.1 llm_config.optimizer.lr=6.0e-5"
