...
. $HOME/projects/pollen_worker/llm_slurm/set_llm_config.sh "3B"
...
POLLEN_CONFIG="pollen.server_address='localhost:51744' run_uuid=$RUN_UUID pollen.refresh_period=5 fl.n_rounds=176 pollen.checkpoint=true llm_config.scheduler.t_max=51500ba llm_config.scheduler.t_warmup=100ba llm_config.scheduler.alpha_f=0.1 llm_config.optimizer.lr=1.6e-4 llm_config.save_overwrite=true pollen.n_nodes=1 pollen.resume_round=-1 pollen.fit_collaborative=true pollen.restore_run_uuid=null"
