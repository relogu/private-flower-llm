...
POLLEN_CONFIG="pollen.server_address='38.80.122.178:50744' run_uuid=$RUN_UUID pollen.refresh_period=5 fl.n_rounds=176 pollen.checkpoint=true llm_config.scheduler.t_max=24800ba llm_config.scheduler.t_warmup=100ba llm_config.scheduler.alpha_f=0.1 llm_config.optimizer.lr=2.0e-4 llm_config.save_overwrite=true pollen.n_nodes=4 pollen.resume_round=0"
