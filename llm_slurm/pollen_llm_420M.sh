...
. $HOME/projects/pollen_worker/llm_slurm/set_llm_config.sh "420M"
...
POLLEN_CONFIG="pollen.server_address='[::]:50744' run_uuid=$RUN_UUID pollen.refresh_period=10 fl.n_rounds=176 pollen.checkpoint=true llm_config.scheduler.t_max=16000ba llm_config.scheduler.t_warmup=100ba llm_config.scheduler.alpha_f=0.01 llm_config.optimizer.lr=2.8e-4 llm_config.save_overwrite=true pollen.n_nodes=4 pollen.resume_round=-1 pollen.fit_collaborative=true"
