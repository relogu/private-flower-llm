...
CUSTOM_HYDRA_ARGS="-m run_uuid=$run_uuid task=shakespeare_memory task.num_rounds=100 local_epochs=1,2,5 task.learning_rate=0.005,0.05,0.5,0.65,0.8,0.9,0.95 task.batch_size=4,8,16 flwr_address=127.0.0.1:1043"
