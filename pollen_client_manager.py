...
class PollenClientManager(ClientManager):
    """Provides a pool of available clients and node managers."""
    ...
    def num_available(self) -> int:
        """Return the number of available virtual clients.
    ...
    def num_available_node_managers(self) -> int:
        """Return the number of available `NodeManager`s.

        Returns
        -------
        num_available : int
            The number of currently available `NodeManager`s.
        """
    ...
    def unregister(self, client: ClientProxy) -> None:
        ...
        if client.cid in self.node_managers:
            del self.node_managers[client.cid]
