...
def main(cfg: DictConfig) -> None:
    ...
    n_workers = min(pool_size, num_available_gpus *
                    get_n_worker_gpu_type(cfg.task.name)[gpu_name[0]])
        ...
        "_system_config": {
            "object_spilling_config": json.dumps(
                {"type": "filesystem", "params": {
                    "directory_path": "/hdd1/ray/ray_spilled_objects/"}},
            )
        },
    }
